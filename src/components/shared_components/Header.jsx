            ...
            <div className='flex justify-between items-center py-1 pr-5'>
                ...
                {/* <div>
                    ...
                    <div className="dropdown dropdown-end ">
                        ...
                        <ul tabIndex={3} className="dropdown-content menu bg-slate-700 rounded-md z-[1] w-[180px] lg:w-[400px] p-3 shadow-lg mt-2">
                            <div className='flex flex-wrap gap-10'>
                                <Link to='/users' className='flex gap-2 items-center'>
                                    ...
                                    <div className='mr-1'>
                                        ...
                                        <p className='text-gray-300 text-sm'>Add new User </p>
                                    </div>
                                </Link>
                                <Link to='/newcustomer' className='flex gap-2 items-center'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-gray-300 text-sm'>Add new customer</p>
                                    </div>
                                </Link>
                                <Link to='/newproject' className='flex gap-2 items-center'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-gray-300 text-sm'> Create a project</p>
                                    </div>
                                </Link>
                                <Link to='/tasks' className='flex gap-2 items-center'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-gray-300 text-sm'>Add a new task</p>
                                    </div>
                                </Link>
                                <div className='flex gap-2 items-center'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-gray-300 text-sm'> Add a new Chat</p>
                                    </div>
                                </div>
                                <div className='flex gap-2 items-center'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-gray-300 text-sm'>Add new Ticket</p>
                                    </div>
                                </div>
                                <div className='flex gap-2 items-center'>
                                    <i class="py-1 px-3 bg-stone-400 text-white fa-solid fa-clipboard-list text-lg rounded-lg  hover:scale-110"></i>
                                    <div>
                                        <h1 className='text-stone-400 font-semibold '>Invoice</h1>
                                        <p className='text-gray-300 text-sm'>Add new Invoice</p>
                                    </div>
                                </div>
                            </div>
                        </ul>
                    ...
                    <div className='dropdown dropdown-end ' >
                        ...
                        <ul tabIndex={1} className="dropdown-content z-50 menu p-2 shadow  rounded-md w-56 bg-slate-700">
                            <li className='border-b-2 text-gray-200 border-gray-500 p-2 text-base font-bold '>Admin</li>
                            <div className='border-b-2 text-gray-200 font-semibold border-gray-500 p-2'>
                                {availableText}
                                <div className='flex gap-3'>
                                    <button onClick={() => handleAvailability(0)} className='bg-green-600 rounded-full border-white border-2 w-6 h-6'></button>
                                    <button onClick={() => handleAvailability(1)} className='bg-yellow-600 rounded-full border-white border-2 w-6 h-6'></button>
                                    <button onClick={() => handleAvailability(2)} className='bg-gray-500 rounded-full border-white border-2 w-6 h-6'></button>
                                    <button onClick={() => handleAvailability(3)} className='bg-red-500 rounded-full border-white border-2 w-6 h-6'></button>

                                </div>
                            </div>
                            <Link to='/profile' className='border-b-2 border-gray-500 text-gray-200 p-2 hover:text-blue-200 hover:font-bold hover:scale-105'> <i class="fa-solid fa-user mr-1"></i>Profile</Link>

                            <Link to="/login" className='p-2 hover:text-blue-200 text-gray-200 hover:font-bold hover:scale-105' > <i class="fa-solid fa-power-off mr-1"></i> Logout</Link >
                        </ul>
                    </div>
