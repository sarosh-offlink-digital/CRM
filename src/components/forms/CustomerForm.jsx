...
const CustomerForm = ({ id }) => {
    ...
    return (
        <div className='p-4'>
            <Header />
            <div className='my-10'>
                <div className='bg-gradient-to-r from-purple-900 via-blue-600 to-blue-900 rounded-t-md p-4 '>
                ...
                <form action='' className='flex flex-col items-center lg:flex-row justify-start'>
                    <div className='bg-slate-800  p-4 rounded-b-md py-10 w-full border-2 border-slate-900'>
                        <div>
                            <h1 className='text-xl mb-2 font-bold text-white '>Customer Details</h1>
                            <div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-6 ">
                                    <label className="flex items-center bg-gray-800 border-white text-white input focus:border-white input-bordered gap-2 w-full  shadow-lg">
                                        <i className="fa-solid fa-user text-blue-500"></i>
                                        <input type="text" className=" grow border-none focus:ring-0 focus:outline-none" placeholder='Customer Name' value={customerDetail.customerName} onChange={handleCustomerDetail('customerName')} />
                                    </label>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-6">
                                    ...
                                    <label className="flex items-center bg-gray-800 border-white text-white input focus:border-white input-bordered gap-2 w-full  shadow-lg">
                                        ...
                                        <select
                                            ...
                                            <option className='text-black' value="" disabled selected hidden>Brand</option>
                                            <option className='text-black' value="Captain Design Agency">Captain Design Agency</option>
                                            <option className='text-black' value="Captain Book Publishing">Captain Book Publishing</option>
                                        </select>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div className='bg-gray-600 w-full h-[2px] my-20'></div>
                        <div>
                            <h1 className='text-xl mb-2 mt-5 font-bold text-white '>Add Invoice</h1>
                            <div>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 my-6">
                                    ...
                                    <label className="flex items-center bg-gray-800 border-white text-white input focus:border-white input-bordered gap-2 w-full  shadow-lg">
                                        ...
                                        <select className="grow bg-transparent border-none focus:ring-0 focus:outline-none" onChange={handlePaymentMethod}>
                                            <option className='text-black' value="" disabled selected hidden>Payment Mode</option>
                                            <option className='text-black' value="Stripe">Stripe</option>
                                            <option className='text-black' value="Wise">Wise</option>
                                    ...
                                    <label className="flex items-center bg-gray-800 border-white text-white input focus:border-white input-bordered gap-2 w-full  shadow-lg">
                                        ...
                                        <select className="grow bg-transparent border-none focus:ring-0 focus:outline-none" onChange={handleCurrency} >
                                            <option className='text-black' value="" disabled selected hidden>Currency</option>
                                            <option className='text-black' value="$">$ USD</option>
                                            <option className='text-black' value="£">£ GBP</option>
                                            <option className='text-black' value="€">€ EUR</option>
                                            <option className='text-black' value="$">$ AUD</option>
                                            <option className='text-black' value="$">$ CAD</option>
                                        </select>
                                    </label>
                                </div>
                                ...
                                <div>
                                    {items.map(item => (
                                        <div key={item.id}>
                                            <div className="grid grid-cols-1 md:grid-cols-5 gap-5 my-6">
                                                <label className="flex items-center bg-gray-800 border-white text-white input input-bordered gap-2 w-full  shadow-md">
                                                ...
                                                <label className="flex items-center bg-gray-800 border-white text-white input input-bordered gap-2 w-full lg:w-auto shadow-md">
                                                    <i className="fa-regular fa-square-plus text-blue-800"></i>
                                                    <input
                                                        type="text"
                                                        className="grow bg-transparent border-none focus:ring-0 focus:outline-none"
                                            ...
                                            <div className='flex justify-between'>
                                                <textarea
                                                    type="text"
                                                    className="grow bg-gray-800 border-white text-white input input-bordered gap-2 w-full lg:w-auto shadow-md"
                                                    placeholder="Description" onChange={(e) => handleInputChange(item.id, 'itemDescription', e.target.value)}
                                                ></textarea>
                                                <button
                                                    type="button" data-tip='Remove'
                                                    className='tooltip tooltip-top rounded-lg border-2 border-blue-500 text-blue-500 text-xl font-bold px-4 shadow-md w-11 h-12 mx-4'
                                                ...
                                                <div className='flex w-full justify-end mt-5 '>
                                                    <div className='flex justify-end items-center'>
                                                        <div>
                                                            ...
                                                            <div className='flex'>
                                                                <p className='text-lg mx-1 font-bold text-blue-500 '>Amount = {item.totalCost}</p>
                                ...
                                <button
                                    type="button"
                                    data-tip='Add item'
                                    className="tooltip border-2 text-blue-500 border-blue-500 p-3 my-5 shadow-md  rounded-md"
                                    onClick={addItem}>
                                    <i className="fa-regular fa-square-plus"></i> Add Item
                                </button>
                            </div>
                            <div className='bg-gray-600 w-full h-[2px] my-6 '></div>



                            {/* INVOICE DIV S */}
                            <div id={id} ref={nodeRef} className='bg-slate-800  text-white w-full lg:py-4 lg:px-10'>
                                <div className='my-8'>
                                    <div className='flex items-center justify-between my-10'>
                                        <h1 className='lg:text-center my-2 text-2xl font-semibold text-blue-500'>Invoice# <span className='font-normal text-white '>0120</span></h1>
                                ...
                                <div className='flex justify-between flex-wrap'>
                                    <div>
                                        <h1 className='text-xl mb-2 mt-5 font-bold text-blue-500'>Total Items:</h1>
                                    ...
                                    <div className='flex flex-col items-end'>
                                        <h1 className='text-xl mb-2 mt-5 text-blue-500 font-bold'>Sub Total</h1>
                                        ...
                                        <p className='text-sm text-blue-500'>Paid via: {paymentMethod}</p>
                                    </div>
                                </div>
                                <div className='border-b-2 border-dashed my-5'></div>
                            ...
                            <div className='flex justify-between px-10'>
                                <Link
                                    to='/customers'
                                    type="Link"
                                    className="bg-blue-500 p-3 my-5 text-white rounded-md">
