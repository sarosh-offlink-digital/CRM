...
import HRDashboard from '../src/components/Dashboards/HRDashboard'
  ...
  return (
    ...
    <Router>
      <Routes>
        ...
        <Route path="/HRDashboard" element={<HRDashboardWithSideNav leadsData={leadsData} customerData={customerData} />} />
        ...
        <Route path="/HRMS" element={<HumanResourceWithSideNav  />} />
      </Routes>
    </Router>
  );
};
...
const HRDashboardWithSideNav = ({ leadsData, customerData }) => <LayoutWithSideNav component={<HRDashboard leadsData={leadsData} customerData={customerData} />} />;
...
const HumanResourceWithSideNav = () => <LayoutWithSideNav component={<HumanResource />} />;
